...
//TODO добавить информацию о клиенте, адрес доставки, телефон. Универсифицировать компонент для пользователя и админа
    ...
    return (
        <>
            <Row className="justify-content-sm-between">
                ...
                <span>Изменить статус через селект</span>
            </Row>
            <Row>
                                        ...
                                        <tbody>
                                            <tr>
                                                ...
                                                <td className="td-product">
                                                    ...
                                                    <p>
                                                        Most beautiful agenda
                                                        for the office, really
                                                        nice paper and black
                                                        cover. Most beautiful
